...
function openModal(templateId) {
  ...
  modalInner.appendChild(tpl.content.cloneNode(true));
...
// Open via row click or button click
document.querySelectorAll('.proj-row[data-modal]').forEach(row => {
  row.addEventListener('click', e => {
    // Don't re-fire if clicking a link inside the row
